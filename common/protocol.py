class Protocol:
    FORMAT = 'utf-8'
    REQUEST_HEADERS = [
        'REGISTER', 'LOGIN', 'LOGOUT', 'HELLO', 'CHATREQUEST', 'SEARCH', 'CHATREQUESTREG', 'CHAT', 'MULTICHAT','MULTICHATREQ','MULTICHATREQREG', 'NEWPEER','PEERS'
    ]
    RESPONSE_HEADERS = [
        'OK', 'REJECT', 'BUSY', 'INVALID', 'NOTFOUND', 'MULLTIOK', 'MULTIREJECT', 'MULTIBUSY', 'LEAVE','PEERS'
    ]
    HEADER_LENGTH = 16
